package com.example.finstability;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

public class StableFinModule {
    public static void main(String[] args) {
        ...
        */
        ...
        //     long totalSaving=beforeRetirementPlan(0, 46000,5000, r, time);
        //     double balance=totalSaving;
        //     retirementPlan(balance, 6  , 25000,
        //          6 , time, 25);
        New.execute();
...
class New{
    public static void execute() {
        int[] num={1,2,4,3,5,7,8,90,0,00,12,35,14,47,560,013};
        String[] nam={"harish","amish","hari","Aman","Kesab","Jack","daniel","jojo"};

        Arrays.stream(num).filter(n -> n > 20).forEach(System.out::println);
